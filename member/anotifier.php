...
/** 
 * Including PHP Mailer liabrary to set up smtp.
 * Always include these namespaces to use the classes.
 */
use PHPMailer\PHPMailer\PHPMailer;
use PHPMailer\PHPMailer\Exception;
use PHPMailer\PHPMailer\SMTP;

require_once('../Liabraries/PHPMailer/src/Exception.php');
require_once('../Liabraries/PHPMailer/src/PHPMailer.php');
require_once('../Liabraries/PHPMailer/src/SMTP.php');
...
/** Creates a html message to send in email.
 *  @param string $uname First Name and Last Name of user. 
 *  @param string $txt contains user credentials.
 *  @param array $general General Settings of Website.
 *  @return string $message Message to be sent in email.
 */
function htmlEmailMessage($uname, $txt, $general) {
...
$message = htmlEmailMessage($uname, $txt, $general);
// More headers
// $headers .= 'From: <contactnarwal@gmail.com>' . "\r\n";
// $headers .= 'Cc: contactnarwal@gmail.com' . "\r\n";
...
try {
    ...
    $mail->Username   = 'mailtonarwal@gmail.com';                     // SMTP username
    $mail->Password   = 'iamsecure@123';                               // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
    $mail->Port       = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('contactnarwal@gmail.com', 'All Earth');
    $mail->addAddress($to, $uname);     // Add a recipient
    // $mail->addAddress('mailtonarwal@gmail.com', 'Devender Narwal');               // Name is optional
    // $mail->addReplyTo("$general[1]", "$general[0] Team");
