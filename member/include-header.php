...
$ullevel= mysql_fetch_array(mysql_query("SELECT `level` FROM `users` WHERE username='".$user."'"));
$accountpayment= array(30,74,148,296, 740, 1480);
$comission= array(13,33,66,132,333,666);
$llevel= $ullevel['level'];
$lpayment= $accountpayment[$llevel];
$lcomission= $comission[$llevel];
$uid = $userdetails[0];
