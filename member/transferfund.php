...
<div class="col-md-4"><b class="btn btn-primary  btn-block">Minimum 01 USD Can be Transferred</b></div>
</div>
</div></div>
...
$amount USD Transfered  Successfully! You Have $willupdate USD .
</div>";
...
$txt = "This is a soft notification that you just Sent $amount USD to $transferto.";
...
$des = "Transfer $amount USD TO $sendto[1] ";
////------------------------------>>>>>>>>>TRX
...
$txt = "This is a soft notification that you just Got $amountToSend USD From $user.";
...
$des = "Transfer $amountToSend USD FROM $user ";
////------------------------------>>>>>>>>>TRX
...
<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>	
$amountToSend USD Transfered To  $transferto
</div>";
...
echo "<div class=\"alert alert-danger alert-dismissable\">
<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>	
Minimum Limit of Transfer is 1 USD !!
</div>";
}		
