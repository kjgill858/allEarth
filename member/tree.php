...
$countsl =  mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE posid='".$root[0]."' AND position='L' AND `refid`='".$root[0]."'"));
...
$sl = mysql_fetch_array(mysql_query("SELECT mid, username, fname, lname, paid_status FROM users WHERE posid='".$root[0]."' AND position='L' AND `refid`='".$root[0]."'"));
if($sl[4]==0){
$paid = '<b class="btn btn-warning btn-block">FREE</b>';
}else{
$paid = '<b class="btn btn-primary btn-block">PAID</b>';
...
<?php
$tllc = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE posid='".$sl[0]."' AND position='L' AND `refid`='".$root[0]."'"));
if($tllc[0]==0){
?>
...
$tll = mysql_fetch_array(mysql_query("SELECT mid, username, fname, lname, paid_status FROM users WHERE posid='".$sl[0]."' AND position='L' AND `refid`='".$root[0]."'"));
if($tll[4]==0){
$paid = '<b class="btn btn-warning btn-block">FREE</b>';
}else{
$paid = '<b class="btn btn-primary btn-block">PAID</b>';
...
<?php
$tlrc = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE posid='".$sl[0]."' AND position='R' AND `refid`='".$root[0]."'"));
if($tlrc[0]==0){
...
$tlr = mysql_fetch_array(mysql_query("SELECT mid, username, fname, lname, paid_status FROM users WHERE posid='".$sl[0]."' AND position='R' AND `refid`='".$root[0]."'"));
if($tlr[4]==0){
$paid = '<b class="btn btn-warning btn-block">FREE</b>';
}else{
$paid = '<b class="btn btn-primary btn-block">PAID</b>';
...
$countsr =  mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE posid='".$root[0]."' AND position='R' AND `refid`='".$root[0]."'"));
...
$sr = mysql_fetch_array(mysql_query("SELECT mid, username, fname, lname, paid_status FROM users WHERE posid='".$root[0]."' AND position='R' AND `refid`='".$root[0]."'"));
if($sr[4]==0){
$paid = '<b class="btn btn-warning btn-block">FREE</b>';
}else{
$paid = '<b class="btn btn-primary btn-block">PAID</b>';
...
<?php
$tllc = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE posid='".$sr[0]."' AND position='L' AND `refid`='".$root[0]."'"));
if($tllc[0]==0){
?>
...
$tll = mysql_fetch_array(mysql_query("SELECT mid, username, fname, lname, paid_status FROM users WHERE posid='".$sr[0]."' AND position='L' AND `refid`='".$root[0]."'"));
if($tll[4]==0){
$paid = '<b class="btn btn-warning btn-block">FREE</b>';
}else{
$paid = '<b class="btn btn-primary btn-block">PAID</b>';
...
<?php
$tlrc = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM users WHERE posid='".$sr[0]."' AND position='R' AND `refid`='".$root[0]."'"));
if($tlrc[0]==0){
...
$tlr = mysql_fetch_array(mysql_query("SELECT mid, username, fname, lname, paid_status FROM users WHERE posid='".$sr[0]."' AND position='R' AND `refid`='".$root[0]."'"));
if($tlr[4]==0){
$paid = '<b class="btn btn-warning btn-block">FREE</b>';
}else{
$paid = '<b class="btn btn-primary btn-block">PAID</b>';
